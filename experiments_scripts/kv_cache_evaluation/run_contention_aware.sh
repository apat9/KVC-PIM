#!/bin/bash
# Contention-Aware Policy evaluation
...
OUTPUT_DIR="$PROJECT_ROOT/exp_results/kv_cache_evaluation/contention_aware"

mkdir -p "$OUTPUT_DIR"

echo "Running Contention-Aware Policy Evaluation"
echo "Model: $MODEL"
echo "Tokens: $NUM_TOKENS"
echo "Output: $OUTPUT_DIR"

# Run simulation with contention-aware policy
$SIMULATOR_BIN \
  ...
  --param "Frontend.KVCachePolicy.impl=ContentionAware" \
...
echo "Contention-Aware evaluation complete. Results in $OUTPUT_DIR"
